...
define ( "BOT_TOKEN", '490146007:AAGvlzSDzCWo-SfPjxVgZLwprVW3k0OGfFE' );

// Custom Helpers
require_once '/vendor/autoload.php';

require_once '/bot/helpers/Curl.php';
require_once '/bot/helpers/Common.php';
require_once '/bot/helpers/BotKeyboard.php';
require_once '/bot/helpers/QueryCommon.php';
...
if (!is_null($callback)) {
    ...
    if (isset($data->page)) {
        ...
        $params = BotKeyboard::manufacturers($message, $chat, $cache, $lang);
        ...
        $params = BotKeyboard::deliveryTerms($chat, $lang);
        ...
        $params = BotKeyboard::deleteMessage($message, $chat);
        ...
        $params = BotKeyboard::location($chat, $lang);
        ...
        if (($data->s == BCommon::STATUS_RESTARAUNT && !isset($data->back)) || ($data->s == BCommon::STATUS_CATEGORY && isset($data->back))) {
            ...
            $params = BotKeyboard::categories($chat, $items, $data->m, 0, $cartCount, $cache, $lang);
            ...
            if ($cart) {
                $params = BotKeyboard::backToHome($chat, $data->m, $lang);
            ...
            if ($cart) {
                $params = BotKeyboard::alert($callback, $languages[$lang]["msg_clear_cart"]);
            ...
            $params = BotKeyboard::products($chat, $products, $data->m, $data->c, 0, $cartCount, $cache, $lang);
            ...
            $params = BotKeyboard::product($chat, $product, $data->m, $data->c, 1, $lang);
            ...
            $params = BotKeyboard::alert($callback, $languages[$lang]["msg_add_cart"]);
            ...
            if (intval($cartCount) > 0) {
                ...
                if (!empty($products)) {
                    ...
                    $params = BotKeyboard::cart($chat, $products, $cache, $lang);
                    ...
                    $params = BotKeyboard::alert($callback, $languages[$lang]["msg_clear_cart"], true);
                ...
                $params = BotKeyboard::alert($callback, $languages[$lang]["msg_empty_cart"]);
            ...
            $params = BotKeyboard::deliveryMethod($chat, $cache, $products, $lang);
            ...
            $params = BotKeyboard::deliveryType($chat, $cache, $products, $data->pickup, $lang);
            ...
            if (isset($data->h)) {
                ...
                $params = BotKeyboard::alert($callback, $languages[$lang]["msg_time_saved"]);
            ...
            $params = BotKeyboard::payments($chat, $payments, $delivery_id, $cache, $products, $date, $time, $lang);
            ...
            $params = BotKeyboard::calendar($chat, $data->y, $data->m, $data->pickup, $lang);
            ...
            if (strtotime($data->y.'-'.$data->m.'-'.$data->d) < strtotime(date("Y-m-d"))) {
                $params = BotKeyboard::alert($callback, $languages[$lang]["msg_calendar_old_date"]);
            ...
            if (isset($data->y)) {
                ...
                $params = BotKeyboard::alert($callback, $languages[$lang]["msg_date_saved"]);
            ...
            /*if (!$work_finish || !$work_start) {
                ...
                $params = BotKeyboard::time($chat, $work_start, $work_finish, $data->pickup, $man, $lang);
                try {
                    $telegram->sendMessage($params);
                } catch (Exception $e) {
                    BCommon::errorLog($telegram, $e->getMessage());
            ...
            $params = BotKeyboard::contact($chat, $lang);
        ...
        $params = BotKeyboard::categories($chat, $categories, $data->m, $currentPage, $cartCount, $cache, $lang);
        ...
        $params = BotKeyboard::products($chat, $products, $data->m, $data->c, $currentPage, $cartCount, $cache, $lang);
        ...
        $params = BotKeyboard::product($chat, $product, $data->m, $data->c, $quantity, $lang, $message->getMessageId());
        ...
        $params = BotKeyboard::calendar($chat, $data->y, $data->m, $data->pickup, $lang, $message->getMessageId());
        ...
        $params = BotKeyboard::alert($callback, $languages[$lang]["msg_calendar_incoeerct"]);
    ...
    if (strtolower($chat->getType()) === "private") {
        ...
        if (!is_null($location)) {
            ...
            $params = BotKeyboard::hideKeyboard($chat, $lang);
            ...
            if ($response !== null) {
                ...
                $params = BotKeyboard::deleteMessage($response, $chat);
            ...
            $params = BotKeyboard::comment($chat, $lang);
        ...
        if (!empty($text) && !$user->isBot()) {
            ...
            if (strtolower($text) === "/start") {
                ...
                $params = BotKeyboard::languages($chat, $user);
                ...
                if ($res["status"]) {
                    ...
                    // $params = BotKeyboard::hideKeyboard($telegram, $chat, $messageId);
                    ...
                    $params = BotKeyboard::success($chat, $lang, $order_code);
                ...
                if ($pageStatus == BCommon::STATUS_COMMENT) {
                    ...
                    $params = BotKeyboard::confirm($chat, $userObj, $products, $payments, $cache, $lang);
